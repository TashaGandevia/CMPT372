...
export const ZONES = [
  ...
  },
  {
    ...
    subsections: [
      ...
      { id: 'sql', name: 'SQL' },
      { id: 'postgres-node', name: 'PostGresSQL and Node JS' },
      { id: 'blob-storage', name: 'BLOB storage' },
      { id: 'database-normalization', name: 'Database Normalization' },
      { id: 'deployment', name: 'Deployment' },
      { id: 'choosing-sql-nosql', name: 'Choosing SQL vs NoSQL' },
    ],
  },
  {
    id: 'z5',
